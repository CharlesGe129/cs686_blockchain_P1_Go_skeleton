...
func TestExt(t *testing.T) {
	...
	check_mpt("TestExt 133", mpt.Order_nodes(),"./mpt_tests/ext_133.txt", t)
	mpt.Delete("bc")
	check_eq("TestExt 133", mpt.Order_nodes(), inserted_trie, t)
	v, _ = mpt.Get("aap")
	check_eq("TestExt 133", v, "banana", t)
	...
	inserted_trie = mpt.Order_nodes()
	mpt.Insert("ab", "new")
	check_mpt("TestExt 311", mpt.Order_nodes(),"./mpt_tests/ext_311.txt", t)
	mpt.Delete("c")
	check_mpt("TestExt 311", mpt.Order_nodes(),"./mpt_tests/ext_311.txt", t)
	mpt.Delete("ab")
	check_eq("TestExt 311", mpt.Order_nodes(), inserted_trie, t)
	v, _ = mpt.Get("aap")
	check_eq("TestExt 311", v, "banana", t)
	...
	inserted_trie = mpt.Order_nodes()
	mpt.Insert("abb", "new")
	check_mpt("TestExt 313", mpt.Order_nodes(),"./mpt_tests/ext_313.txt", t)
	mpt.Delete("c")
	check_mpt("TestExt 313", mpt.Order_nodes(),"./mpt_tests/ext_313.txt", t)
	mpt.Delete("abb")
	check_eq("TestExt 313", mpt.Order_nodes(), inserted_trie, t)
	v, _ = mpt.Get("aap")
	check_eq("TestExt 313", v, "banana", t)
	...
	inserted_trie = mpt.Order_nodes()
	mpt.Insert("aa", "new")
	check_mpt("TestExt 340", mpt.Order_nodes(),"./mpt_tests/ext_340.txt", t)
	mpt.Delete("c")
	check_mpt("TestExt 340", mpt.Order_nodes(),"./mpt_tests/ext_340.txt", t)
	mpt.Delete("aa")
	check_eq("TestExt 340", mpt.Order_nodes(), inserted_trie, t)
	v, _ = mpt.Get("aaaaa")
	check_eq("TestExt 340", v, "banana", t)
	...
	inserted_trie = mpt.Order_nodes()
	mpt.Insert("ab", "new")
	check_mpt("TestExt 331", mpt.Order_nodes(),"./mpt_tests/ext_331.txt", t)
	mpt.Delete("c")
	check_mpt("TestExt 331", mpt.Order_nodes(),"./mpt_tests/ext_331.txt", t)
	mpt.Delete("ab")
	check_eq("TestExt 331", mpt.Order_nodes(), inserted_trie, t)
	v, _ = mpt.Get("aaap")
	check_eq("TestExt 331", v, "banana", t)
	...
	inserted_trie = mpt.Order_nodes()
	mpt.Insert("abb", "new")
	check_mpt("TestExt 333", mpt.Order_nodes(),"./mpt_tests/ext_333.txt", t)
	mpt.Delete("c")
	check_mpt("TestExt 333", mpt.Order_nodes(),"./mpt_tests/ext_333.txt", t)
	mpt.Delete("abb")
	check_eq("TestExt 333", mpt.Order_nodes(), inserted_trie, t)
	v, _ = mpt.Get("aaap")
	check_eq("TestExt 333", v, "banana", t)
}
...
func TestLeaf(t *testing.T) {
	...
	mpt.Insert("aab", "apple")
	mpt.Insert("aab", "new")
	check_mpt("TestLeaf 300", mpt.Order_nodes(),"./mpt_tests/leaf_300.txt", t)
	mpt.Delete("c")
	check_mpt("TestLeaf 300", mpt.Order_nodes(),"./mpt_tests/leaf_300.txt", t)
	mpt.Delete("aab")
	check_eq("TestLeaf 300", mpt.Order_nodes(), inserted_trie, t)

	mpt.Initial()
	mpt.Insert("ap", "apple")
	inserted_trie = mpt.Order_nodes()
	mpt.Insert("aq", "new")
	check_mpt("TestLeaf 311", mpt.Order_nodes(),"./mpt_tests/leaf_311.txt", t)
	mpt.Delete("c")
	check_mpt("TestLeaf 311", mpt.Order_nodes(),"./mpt_tests/leaf_311.txt", t)
	mpt.Delete("aq")
	check_eq("TestLeaf 311", mpt.Order_nodes(), inserted_trie, t)

	mpt.Initial()
	mpt.Insert("ap", "apple")
	inserted_trie = mpt.Order_nodes()
	mpt.Insert("aqa", "new")
	check_mpt("TestLeaf 313", mpt.Order_nodes(),"./mpt_tests/leaf_313.txt", t)
	mpt.Delete("c")
	check_mpt("TestLeaf 313", mpt.Order_nodes(),"./mpt_tests/leaf_313.txt", t)
	mpt.Delete("aqa")
	check_eq("TestLeaf 313", mpt.Order_nodes(), inserted_trie, t)

	mpt.Initial()
	mpt.Insert("aab", "apple")
	inserted_trie = mpt.Order_nodes()
	mpt.Insert("ab", "new")
	check_mpt("TestLeaf 331", mpt.Order_nodes(),"./mpt_tests/leaf_331.txt", t)
	mpt.Delete("c")
	check_mpt("TestLeaf 331", mpt.Order_nodes(),"./mpt_tests/leaf_331.txt", t)
	mpt.Delete("ab")
	check_eq("TestLeaf 331", mpt.Order_nodes(), inserted_trie, t)

	mpt.Initial()
	mpt.Insert("aab", "apple")
	inserted_trie = mpt.Order_nodes()
	mpt.Insert("aba", "new")
	check_mpt("TestLeaf 333", mpt.Order_nodes(),"./mpt_tests/leaf_333.txt", t)
	mpt.Delete("c")
	check_mpt("TestLeaf 333", mpt.Order_nodes(),"./mpt_tests/leaf_333.txt", t)
	mpt.Delete("aba")
	check_eq("TestLeaf 333", mpt.Order_nodes(), inserted_trie, t)
}
...
func TestLeafBasic(t *testing.T) {
	...
	mpt.Insert("aab", "apple")
	mpt.Insert("app", "banana")
	check_mpt("TestLeafBasic 3", mpt.Order_nodes(),"./mpt_tests/basic_3.txt", t)

	mpt.Initial()
	mpt.Insert("ap", "apple")
	check_mpt("TestLeafBasic 4", mpt.Order_nodes(),"./mpt_tests/basic_4.txt", t)
}
...
func TestExtBasic(t *testing.T) {
	...
	mpt.Insert("aaa", "banana")
	mpt.Insert("aap", "orange")
	check_mpt("TestExtBasic 6", mpt.Order_nodes(),"./mpt_tests/ext_basic_6.txt", t)

	mpt.Initial()
	mpt.Insert("p", "apple")
	mpt.Insert("aaaa", "banana")
	mpt.Insert("aaap", "orange")
	check_mpt("TestExtBasic 7", mpt.Order_nodes(),"./mpt_tests/ext_basic_7.txt", t)

	mpt.Initial()
	mpt.Insert("p", "apple")
	mpt.Insert("aaaaa", "banana")
	mpt.Insert("aaaap", "orange")
	check_mpt("TestExtBasic 8", mpt.Order_nodes(), "./mpt_tests/ext_basic_8.txt", t)
}
